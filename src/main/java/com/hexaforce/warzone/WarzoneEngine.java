...
@Setter
/**
 * This serves as the starting point for the game and maintains the current game
 * state.
 */
public class WarzoneEngine implements Serializable {
     ...
     * 
     * @param p_isTournamentMode True if a tournament is being played, otherwise
     *                           false
     */
     ...
     * them to corresponding logical flows.
     *
    ...
    public static void main(String[] p_args) {
        ...
        l_game.getD_CurrentPhase().getD_gameContext().updateLog("Initializing the Game ......" + System.lineSeparator(),
                "start");
