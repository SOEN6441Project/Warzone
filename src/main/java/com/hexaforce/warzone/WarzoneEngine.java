...
public class WarzoneEngine {
    ...
    /**
     * It is the current game play phase as per state pattern. -- GETTER -- This
     * method is getter for
     * current Phase of Game Context.
     */
    Phase d_currentPhase = new StartupPhase(this, d_gameContext);

    /**
     * This method updates the current phase to Issue Order Phase as per State
     * Pattern.
     */
    ...
    /**
     * This method updates the current phase to Order Execution Phase as per State
     * Pattern.
     */
    ...
    public void setD_gameEngineLog(String p_gameEngineLog, String p_logType) {
        ...
        String l_consoleLogger = p_logType.equalsIgnoreCase("phase")
                ? "\n************ " + p_gameEngineLog + " ************\n"
                : p_gameEngineLog;
