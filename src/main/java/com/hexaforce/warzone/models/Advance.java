...
public class Advance implements Order {
    ...
    /**
     * The constructor accepts all the parameters required to execute the order, and
     * these parameters are then encapsulated in the order.
     * 
     * @param p_playerInitiator      The player who created the order.
     * @param p_sourceCountryName    The country from which armies will be
     *                               transferred.
    ...
    public void execute(GameContext p_gameContext) {
        if (validate(p_gameContext)) {
            ...
            if (l_playerOfTargetCountry.getPlayerName().equalsIgnoreCase(this.d_playerInitiator.getPlayerName())) {
                ...
                produceOrderOutcome(p_gameContext, l_playerOfTargetCountry, l_targetCountry, l_sourceCountry);
            }
        } else {
     ...
     */
    private void produceOrderOutcome(GameContext p_gameContext, Player p_playerOfTargetCountry, Country p_targetCountry,
        ...
        this.produceBattleOutcome(p_sourceCountry, p_targetCountry, l_attackerArmies, l_defenderArmies,
     ...
     */
    private void captureTargetCountry(GameContext p_gameContext, Player p_playerOfTargetCountry,
    ...
    /**
     * If the target territory is owned by the same player, it will only move
     * armies.
     * 
    ...
    /**
     * Determines the outcome of the advance order's battle based on attacker and
     * defender army units.
     * 
     ...
     * @param p_playerOfTargetCountry The player who owns the target country.
     */
    private void produceBattleOutcome(Country p_sourceCountry, Country p_targetCountry, List<Integer> p_attackerArmies,
        ...
        this.manageSurvivingArmies(l_attackerArmiesLeft, l_defenderArmiesLeft, p_sourceCountry, p_targetCountry,
                p_playerOfTargetCountry);
    }
     ...
     */
    public void manageSurvivingArmies(Integer p_attackerArmiesLeft, Integer p_defenderArmiesLeft,
    ...
    /**
     * Validates if the source country given in the advance order belongs to the
     * player's countries.
     * 
    ...
    /**
     * Generates random army units based on the attacker's and defender's winning
     * probabilities.
     * 
     * @param p_size The number of random armies to be generated
     * @param p_role Whether the armies to be generated are for the defender or the
     *               attacker
    ...
    private void updateContinents(Player p_playerOfSourceCountry, Player p_playerOfTargetCountry,
        ...
        l_playerService.performContinentAssignment(l_playesList, p_gameContext.getD_map().getD_continents());
    }
