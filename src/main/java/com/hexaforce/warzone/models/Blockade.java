 ...
 * are used to change
 * one of your territories into a neutral territory and triple the number of
 * armies on that
 * territory.
 */
public class Blockade implements Card, Serializable {
     ...
     * or not and also
     * make sure that any attacks, airlifts, or other actions must happen before the
     * country changes
     * into a neutral.
     *
    ...
    public boolean validate(GameContext p_gameContext) {
        ...
        // Validates whether target country belongs to the Player who executed the order
        // or not
        Country l_country = d_playerInitiator.getD_countriesOwned().stream()
