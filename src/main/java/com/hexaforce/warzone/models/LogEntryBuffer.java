...
public class LogEntryBuffer extends Observable implements Serializable {
    ...
    public void setLog(String p_message, String p_logType) {
        ...
        switch (p_logType.toLowerCase()) {
            case "phase":
                d_logMessage = System.lineSeparator()
                        + "====="
                        + p_message
                        + "====="
                ...
                break;
            case "command":
                d_logMessage = System.lineSeparator() + "Command Entered: " + p_message + System.lineSeparator();
                break;
            case "order":
                d_logMessage = System.lineSeparator() + "Order Issued: " + p_message + System.lineSeparator();
                break;
