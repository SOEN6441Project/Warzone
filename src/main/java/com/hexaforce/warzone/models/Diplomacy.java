...
/**
 * 
 * This class represents the implementation of a Diplomacy card order. The
 * Diplomacy Card enforces peace between two players for a variable number of
 * turns. While peace is enforced, neither player will be able to attack the
 * other. The card takes effect the turn after it is played.
 */
public class Diplomacy implements Card {
    ...
    public void execute(GameContext p_gameContext) {
        ...
        this.setD_orderExecutionLog("Negotiation with " + d_targetPlayer + " initiated by "
                + d_IssuingPlayer.getPlayerName() + " was successful!", "default");
