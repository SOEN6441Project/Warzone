 ...
 * Diplomacy Card enforces
 * peace between two players for a variable number of turns. While peace is
 * enforced, neither player
 * will be able to attack the other. The card takes effect the turn after it is
 * played.
 */
public class Diplomacy implements Card, Serializable {
    ...
    public void printOrder() {
        this.d_orderExecutionLog = "----------Diplomacy order issued by player "
