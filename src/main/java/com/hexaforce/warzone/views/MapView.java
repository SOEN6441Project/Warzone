...
public class MapView {
    ...
    /**
     * Constructor to initialize MapView with the current GameContext and a list of
     * Player objects.
     *
     * @param p_gameContext The current GameContext.
    ...
    private void displayCenteredString(int p_width, String p_s) {
        String l_centeredString = String.format(
                "%-" + p_width + "s",
    ...
    /**
     * Display the continent name with a well-formatted centered string and
     * separator.
     *
    ...
    private void displayFormattedAdjacentCountryName(
        ...
        String l_adjacentCountry = "Connections"
                + " : "
    ...
    /**
     * Display a summary of continents, countries, and the current state of the game
     * as present in the
     * .map files.
     */
    public void showMap() {
