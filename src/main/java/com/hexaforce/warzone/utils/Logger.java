...
/** This class writes the logs to the file. Class. */
public class Logger implements Observer {
  ...
  public void update(Observable p_observable, Object p_object) {
    ...
    try {
      if (l_logMessage.equals(
          "Game is Starting..." + System.lineSeparator() + System.lineSeparator())) {
        Files.newBufferedWriter(Paths.get("Logs.txt"), StandardOpenOption.TRUNCATE_EXISTING)
            .write(" ");
      }
      Files.write(
          Paths.get("Logs.txt"),
          l_logMessage.getBytes(StandardCharsets.US_ASCII),
