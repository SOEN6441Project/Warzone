...
public class Constants {
  public static final String INVALID_COMMAND_ERROR_SAVEGAME =
      "Invalid command. Kindly provide command in Format of : savegame filename";
  public static final String INVALID_COMMAND_ERROR_LOADGAME =
      "Invalid command. Kindly provide command in Format of : loadgame filename";
  ...
  public static final String INVALID_COMMAND_TOURNAMENT_MODE =
      "Invalid Command. Kindly provide command in format of : tournament -M listofmapfiles -P"
  ...
  public static final List<String> PLAYER_BEHAVIORS =
      Arrays.asList("Human", "Aggressive", "Random", "Benevolent", "Cheater");
  public static final List<String> TOURNAMENT_PLAYER_BEHAVIORS =
      Arrays.asList("Aggressive", "Random", "Benevolent", "Cheater");
}
