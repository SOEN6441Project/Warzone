...
//       }
//     } else {
//       System.out.println("Invalid command. Usage: editcontinent -add continentName
// controlValue");
//     }
//   }

//   /**
//    * Handles the "editcountry -add" or "editcountry -remove" command to add or remove a country
// from
//    * the game map.
//    *
...
//         Country l_country = new Country(l_countryId, l_countryName,
// l_continentToAddTo.getName());
...
//   /**
//    * Handles the "editneighbor -add" or "editneighbor -remove" command to add or remove a
// neighbor
//    * to/from a country.
//    *
...
//   /**
//    * Displays the current state of the game map including continents, countries. and connectivity
// in
