...
/**
 * The PlayerController class is responsible for managing player-related
...
public class PlayerController {
    ...
    /**
     * Constructs a new PlayerController and initializes the associated
     * PlayerService.
     */
    ...
    /**
     * Updates players in the game context based on the provided operation and
     * argument.
     *
    ...
    public void updatePlayersInGame(GameContext gameContext) {
        for (Player l_player : gameContext.getD_players()) {
            if (l_player.getD_countriesOwned().size() == 0 && !l_player.getPlayerName().equals("Neutral")
                    && !gameContext.getD_playersFailed().contains(l_player)) {
                this.setD_playerLog(
                        "Player: " + l_player.getPlayerName() + " has lost the game and is left with no countries!");
     ...
     *
     * @param gameContext The game context in which colors will be assigned to
     *                    players.
     */
     ...
     *
     * @param gameContext The game context in which countries will be assigned to
     *                    players.
     */
     ...
     *
     * @param gameContext The game context in which armies will be assigned to
     *                    players.
     */
     ...
     *
     * @param playersList The list of players for which the "flag" property will be
     *                    reset.
     */
    ...
    /**
     * Performs continent assignment for a list of players based on a list of
     * continents.
     *
