...
public class GameEngineController {
	 ...
	 * @throws com.hexaforce.warzone.exceptions.InvalidMap indicates map is invalid
	 * @throws InvalidCommand indicates command is invalid
	 * @throws IOException indicates failure in I/O operation
	 */
	public void handleCommand(String p_enteredCommand) throws InvalidCommand, InvalidCommand, IOException {
		...
		switch (l_rootCommand) {
			...
			case "showmap": {
				Map l_mapView = new MapView(d_gameState);
				l_mapView.showMap();
				break;
			}
		case "exit": {
