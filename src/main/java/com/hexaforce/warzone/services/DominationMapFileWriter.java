...
public class DominationMapFileWriter implements Serializable {
  /**
   * Reads the game state, parses it, and stores it in a specific type of map file.
   *
   ...
   */
  public void parseDominationMapToFile(
      GameContext p_gameContext, FileWriter l_writer, String l_mapFormat) throws IOException {
