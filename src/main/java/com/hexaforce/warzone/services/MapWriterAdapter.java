...
/**
 * The MapWriterAdapter class serves as an adapter for writing to a conquest map
 * file.
 */
public class MapWriterAdapter extends DominationMapFileWriter {
    ...
    /**
     * Adapts the writing process to a different type of map file through the
     * adaptee.
     * 
     ...
     */
    public void parseMapToFile(GameContext d_gameContext, FileWriter l_writer, String l_mapFormat) throws IOException {
