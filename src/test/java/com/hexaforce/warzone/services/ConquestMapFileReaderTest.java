...
public class ConquestMapFileReaderTest {
  ...
  public void testEditMap() throws IOException, InvalidMap, InvalidCommand {
    ...
    Map l_updatedContinents =
        d_mapservice.addRemoveContinents(d_context, d_context.getD_map(), "Add", "Asia 10");
    l_updatedContinents =
        d_mapservice.addRemoveContinents(d_context, d_context.getD_map(), "Add", "Europe 20");
    ...
    assertEquals(
        l_updatedContinents.getD_continents().get(8).getD_continentValue().toString(), "10");

    l_updatedContinents =
        d_mapservice.addRemoveContinents(d_context, d_context.getD_map(), "Remove", "Asia");
