...
public class CommandTest {
    ...
    /**
     * test that if there are more than one spaces in between the command and its parameters is acceptable or not
     */
    @Test
    ...
    /**
     * testing that if more than one spaces in between the command and its parameters is acceptable or not
     */
    @Test
